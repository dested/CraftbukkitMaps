	...
	public WorldMapBase a(Class oclass, String s) {
		...
		if (worldmapbase != null) {
			...
			if (this.a != null) {
				try {
					...
					if (file1 != null && file1.exists()) {
						try {
							worldmapbase = (WorldMapBase) oclass
									.getConstructor(
											new Class[] { String.class })
									.newInstance(new Object[] { s });
						} catch (Exception exception) {
							throw new RuntimeException("Failed to instantiate "
									+ oclass.toString(), exception);
						}
			...
			if (worldmapbase != null) {
				...
				// Craftbukkit start
				CraftMapManager.getSingleton().activate(
						new CraftMapView((WorldMap) worldmapbase));
				// Craftbukkit end
		...
		if (this.a != null) {
			try {
				...
				if (file1 != null) {
					...
					CompressedStreamTools.a(nbttagcompound1,
		...
		if (this.a == null) {
			...
			try {
				...
				if (file1 != null) {
					...
					CompressedStreamTools.a(nbttagcompound,
